...
function manhattan_food(gameState) {
  ...
  gameState.board.food.forEach((food) => {
    ...
    let manhattan_distance =
      Math.abs(myHead.x - food.x) + Math.abs(myHead.y - food.y); //The difference of the absolute values ​​of x plus the difference of the absolute values ​​of y of the two points(The head and each food are the two points)
